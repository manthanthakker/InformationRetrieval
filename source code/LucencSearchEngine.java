 ...
 * @author manth
 */
public class LucencSearchEngine {
	...
	String s = "";//br.readLine();
        s="inputforLucene\\data\\index";

	LucencSearchEngine indexer = null;
	try {
	    indexLocation = s;
	    indexer = new LucencSearchEngine(s);
	} catch (Exception ex) {
	...
	while (!s.equalsIgnoreCase("q")) {
	    try {
		System.out
			.println("Press q to quit else press any key to continue ");
		//System.out
	...
	//TopScoreDocCollector collector = TopScoreDocCollector.create(100, true);
       // System.out.println(get_test_queries());
     ...
     */
    LucencSearchEngine(String indexDir) throws IOException {
    ...
    public static HashMap<String,String> get_test_queries()
    {
      ...
      try {
         FileInputStream fileIn = new FileInputStream("inputforLucene\\query-test.ser");
